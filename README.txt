...
Keep settings and click Ok> in colom 1 click the arrows that point both ways > Make sure all fields are selected and click Ok > 
Select Transform from the top Ribbon and click DetectDataType > Select Home in the ribbon and click LoadTable > 
